 ...
 */
final class Version20250708164612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, logo_id INT DEFAULT NULL, name JSON NOT NULL COMMENT '(DC2Type:json)', negative_count INT NOT NULL, positive_count INT NOT NULL, INDEX IDX_C1EE637CF98F144A (logo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
